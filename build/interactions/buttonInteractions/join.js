...
const join = (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const row = (0, actionRow_1.actionRow)([
        (0, messageButton_1.messageButton)(bot_1.CustomIds.ButtonJoin, 'Join', 'SUCCESS'),
        (0, messageButton_1.messageButton)(bot_1.CustomIds.ButtonLeave, 'Leave', 'DANGER')
    ]);
